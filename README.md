...
## 🚀 Installing StoryPlay on Windows
...
3. A setup window will open. Follow on-screen instructions.
4. Choose the folder where you want to install StoryPlay or use the default.
...
## ▶️ Running StoryPlay for the First Time

To open StoryPlay:

1. Find the StoryPlay icon either on your Desktop or in the Start menu.
...
## 🖥️ What You Need to Use StoryPlay
...
## 🛠️ Using StoryPlay - Key Features
...
2. Name your story and choose a save location.
3. The editor opens with one starting node.
4. Click the node to add text or narration.
5. Add choices by creating new linked nodes.
6. Use the panel on the right to set variables or conditions if needed.
7. Press the “Play” button to preview how your story works.

Try changing text or connecting nodes differently. Experimenting helps you learn.

## 🔍 Tips for Smooth Story Building
